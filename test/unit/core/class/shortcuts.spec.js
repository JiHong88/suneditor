...
describe('Core - Shortcuts', () => {
    ...
    describe('Constructor', () => {
        it('should initialize with editor reference', () => {
            expect(shortcuts.editor).toBe(editor);
        });

        it('should initialize with isDisabled as false', () => {
            expect(shortcuts.isDisabled).toBe(false);
        });
    });
    ...
    describe('disable method', () => {
        it('should set isDisabled to true', () => {
            shortcuts.disable();
            expect(shortcuts.isDisabled).toBe(true);
        });
    });

    describe('enable method', () => {
        it('should set isDisabled to false', () => {
            shortcuts.isDisabled = true;
            shortcuts.enable();
            expect(shortcuts.isDisabled).toBe(false);
        });
    });
    ...
    describe('command method', () => {
        ...
        it('should handle ctrl+key shortcuts', () => {
            ...
            editor.shortcutsKeyMap.set('KeyB', mockInfo);
        ...
        it('should handle ctrl+shift+key shortcuts', () => {
            ...
            editor.shortcutsKeyMap.set('KeyB1000', mockInfo);
        ...
        it('should handle text-based shortcuts', () => {
            ...
            editor.shortcutsKeyMap.set('##', mockInfo);
            mockEvent.key = '#';
        ...
        it('should return false if shift is required but not pressed', () => {
            ...
            editor.shortcutsKeyMap.set('KeyA', mockInfo);
        ...
        it('should return false if space is required but not pressed', () => {
            ...
            editor.shortcutsKeyMap.set('test', mockInfo);
        ...
        it('should handle text + event.key combination shortcuts', () => {
            ...
            editor.shortcutsKeyMap.set('ab', mockInfo);
            mockEvent.key = 'b';
