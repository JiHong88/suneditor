...
a.style.display?a.style.display:"block");var e=document,c=e.createElement("DIV");c.className="sun-editor";c.id="suneditor_"+a.id;c.style.width=d.width;c.style.display=d.display;var f=e.createElement("DIV");f.className="sun-editor-container";var b=e.createElement("DIV");b.className="sun-editor-id-toolbar";b.innerHTML=A(d.buttonList);var g=e.createElement("DIV");g.className="sun-editor-id-editorArea";g.style.height=d.height;var k=e.createElement("IFRAME");k.allowFullscreen=!0;k.frameBorder=0;k.className=
    ...
    getRange:function(){var b=this.getSelection();if(0<b.rangeCount)var a=b.getRangeAt(0);else b=this._variable.copySelection,a=this.createRange(),a.setStart(b.anchorNode,b.anchorOffset),a.setEnd(b.focusNode,b.focusOffset);return a},setRange:function(b,a,c,d){var g=this.createRange();g.setStart(b,a);g.setEnd(c,d);b=this.getSelection();0<b.rangeCount&&b.removeAllRanges();b.addRange(g)},showLoading:function(){a.element.loading.style.display="block"},closeLoading:function(){a.element.loading.style.display=
        "none"},getLineElement:function(b){for(;!/^BODY$/i.test(b.parentNode.tagName);)b=b.parentNode;return b},appendP:function(b){b=this.getLineElement(b);var a=document.createElement("P");a.innerHTML="&#65279";b.parentNode.insertBefore(a,b.nextElementSibling)},insertNode:function(b,a){if(a){var c=a.parentNode;a=a.nextSibling}else{var d=this.getSelection();c=this.getRange();var g=c.startContainer,e=c.startOffset,f=c.endContainer,p=c.endOffset;c=g;3===g.nodeType&&(c=g.parentNode);if(g===f&&e===p)d.focusNode&&
    3===d.focusNode.nodeType?a=d.focusNode.splitText(p):(null!==c.lastChild&&/^BR$/i.test(c.lastChild.nodeName)&&c.removeChild(c.lastChild),a=null);else{var r=g;if(g===f)this.isEdgePoint(f,p)||(a=f.splitText(p)),this.isEdgePoint(g,e)||(r=g.splitText(e)),c.removeChild(r);else for(d.deleteFromDocument?d.deleteFromDocument():this.removeNode(),a=f;1!==a.nodeType;)a=a.parentNode}}try{c.insertBefore(b,a)}catch(x){c.appendChild(b)}},removeNode:function(){var b=this.getRange(),a=b.startContainer,c=b.startOffset,
        e=b.endContainer,f=b.endOffset;b=d.getListChildNodes(b.commonAncestorContainer);var n=d.getArrayIndex(b,a);var m=d.getArrayIndex(b,e),p,r=a;for(p=n+1;0<=p;p--)b[p]===r.parentNode&&b[p].firstChild===r&&0===c&&(n=p,r=r.parentNode);r=e;for(p=m-1;p>n;p--)b[p]===r.parentNode&&1===b[p].nodeType&&(b.splice(p,1),r=r.parentNode,--m);for(p=n;p<=m;p++)n=b[p],0===n.length||3===n.nodeType&&void 0===n.data?d.removeItem(n):n===a?(n=1===a.nodeType?document.createTextNode(a.textContent):document.createTextNode(a.substringData(0,
        c)),0<n.length?a.data=n.data:d.removeItem(a)):n===e?(n=1===e.nodeType?document.createTextNode(e.textContent):document.createTextNode(e.substringData(f,e.length-f)),0<n.length?e.data=n.data:d.removeItem(e)):d.removeItem(n)},wrapRangeToTag:function(a,c){var b=this.getRange(),d=b.startContainer,g=b.startOffset,e=b.endContainer,f=b.endOffset,p=b.commonAncestorContainer;b={};var r={};if(c){var x="(?:;|^|\\s)(?:"+c[0];for(t=1;t<c.length;t++)x+="|"+c[t];x+=")\\s*:[^;]*\\s*(?:;|$)";x=new RegExp(x,"gi")}if(d===
        e){var h=a.cloneNode(!1);if(g===f)h.innerHTML="&nbsp;",d.parentNode.insertBefore(h,d.nextSibling);else{e=document.createTextNode(d.substringData(0,g));var v=document.createTextNode(d.substringData(f,d.length-f));h.innerText=d.substringData(g,f-g);d.parentNode.insertBefore(h,d.nextSibling);d.data=0<e.data.length?e.data:d.substringData(0,g);0<v.data.length&&d.parentNode.insertBefore(v,h.nextSibling)}b.container=h;b.offset=0;r.container=h;r.offset=1}else if(v=function(b){if(3===b.nodeType)return!0;var c=
            "";x&&0<b.style.cssText.length&&(c=b.style.cssText.replace(x,"").trim());return b.nodeName!==a.nodeName||0<c.length?(0<b.style.cssText.length&&(b.style.cssText=c),!0):!1},/BODY/i.test(p.nodeName)){r=SUNEDITOR.dom.getListChildren(p,function(b){return/^P$/i.test(b.nodeName)});p=SUNEDITOR.dom.getParentNode(d,"P");var z=SUNEDITOR.dom.getParentNode(e,"P"),t=0;for(b=r.length;t<b;t++)if(p===r[t])p=t;else if(z===r[t]){z=t;break}h=a.cloneNode(!1);b=this._wrapLineNodesStart(r[p],h,v,d,g);for(t=p+1;t<z;t++)h=
        a.cloneNode(!1),this._wrapLineNodes(r[t],h,v);h=a.cloneNode(!1);r=this._wrapLineNodesEnd(r[z],h,v,e,f)}else h=a.cloneNode(!1),d=this._wrapLineNodesPart(p,h,v,d,g,e,f),b.container=d.startContainer,b.offset=d.startOffset,r.container=d.endContainer,r.offset=d.endOffset;this.setRange(b.container,b.offset,r.container,r.offset)},_wrapLineNodesPart:function(b,a,c,d,e,f,m){var g=d,k=e,n=f,h=m,q=!1,u=!1,t,l,w,y=[];(function E(d,e){for(var f=d.childNodes,p=0,r=f.length;p<r&&!u;p++){var m=f[p];if(q&&m!==n&&
        3===m.nodeType){l=m;for(t=[];l!==b&&null!==l;)c(l)&&1===l.nodeType&&t.push(l.cloneNode(!1)),l=l.parentNode;if(0<t.length){for(w=l=t.pop();0<t.length;)l=t.pop(),w.appendChild(l);a.appendChild(w);e=l}else e=a;e.appendChild(m.cloneNode(!1));y.push(m)}if(m===g){var x=document.createTextNode(g.substringData(0,k)),v=document.createTextNode(g.substringData(k,g.length-k));0<x.length?g.data=x.data:y.push(g);l=m;for(t=[];l!==b&&null!==l;)c(l)&&1===l.nodeType&&t.push(l.cloneNode(!1)),l=l.parentNode;for(w=l=
        t.pop()||m;0<t.length;)l=t.pop(),w.appendChild(l);w!==m?(a.appendChild(w),e=l):e=a;g=v;k=0;e.appendChild(g);q=!0}else{if(m===n){f=document.createTextNode(n.substringData(h,n.length-h));p=document.createTextNode(n.substringData(0,h));r=l=m;for(t=[];l!==b&&null!==l;)c(l)&&1===l.nodeType&&t.push(l.cloneNode(!1)),r=l,l=l.parentNode;for(w=l=t.pop()||m;0<t.length;)l=t.pop(),w.appendChild(l);w!==m?(a.appendChild(w),e=l):e=a;0<f.length?n.data=f.data:y.push(n);n=p;h=p.length;e.appendChild(n);for(b.insertBefore(a,
        r);0<y.length;){m=y.pop();for(m.data="";m.parentNode&&0===m.parentNode.innerText.length;)m=m.parentNode;SUNEDITOR.dom.removeItem(m)}u=!0;break}E(m)}}})(b);return{startContainer:g,startOffset:k,endContainer:n,endOffset:h}},_wrapLineNodes:function(a,c,d){(function m(a,b){for(var c=a.childNodes,g=0,e=c.length;g<e;g++){var f=c[g],k=b;if(d(f)){var n=f.cloneNode(!1);b.appendChild(n);1===f.nodeType&&(k=n)}m(f,k)}})(a,c);a.innerHTML="";a.appendChild(c)},_wrapLineNodesStart:function(a,c,d,e,f){var b=e,g=f,
        k=document.createElement("P"),r=!1,u,h,q;(function w(e,f){for(var n=e.childNodes,m=0,p=n.length;m<p;m++){var l=n[m],t=f;if(r){if(1===l.nodeType){w(l,l);continue}h=l;for(u=[];null!==h.parentNode&&h!==a&&h!==c;)d(h)&&1===h.nodeType&&u.push(h.cloneNode(!1)),h=h.parentNode;if(0<u.length){for(q=h=u.pop();0<u.length;)h=u.pop(),q.appendChild(h);c.appendChild(q);f=h}else f=c}if(r||l!==b){if(!r||d(l)){var x=l.cloneNode(!1);f.appendChild(x);1===l.nodeType&&(t=x)}w(l,t)}else{l=document.createTextNode(b.substringData(0,
        g));t=document.createTextNode(b.substringData(g,b.length-g));0<l.data.length&&f.appendChild(l);h=f;for(u=[];h!==k&&null!==h;)d(h)&&1===h.nodeType&&u.push(h.cloneNode(!1)),h=h.parentNode;for(q=h=u.pop()||f;0<u.length;)h=u.pop(),q.appendChild(h);q!==f?(c.appendChild(q),f=h):f=c;k.appendChild(c);b=t;g=0;r=!0;f.appendChild(b)}}})(a,k);a.parentNode.insertBefore(k,a);SUNEDITOR.dom.removeItem(a);return{container:b,offset:g}},_wrapLineNodesEnd:function(a,c,d,e,f){var b=e,g=f,k=document.createElement("P"),
        u=!1,q,h,v;(function w(e,f){for(var n=e.childNodes,m=n.length-1;0<=m;m--){var l=n[m],p=f;if(u){if(1===l.nodeType){w(l,l);continue}h=l;for(q=[];null!==h.parentNode&&h!==a&&h!==c;)d(h)&&1===h.nodeType&&q.push(h.cloneNode(!1)),h=h.parentNode;if(0<q.length){for(v=h=q.pop();0<q.length;)h=q.pop(),v.insertBefore(h,v.firstChild);c.insertBefore(v,c.firstChild);f=h}else f=c}if(u||l!==b){if(!u||d(l)){var r=l.cloneNode(!1);f.insertBefore(r,f.firstChild);1===l.nodeType&&(p=r)}w(l,p)}else{l=document.createTextNode(b.substringData(g,
        b.length-g));p=document.createTextNode(b.substringData(0,g));0<l.data.length&&f.insertBefore(l,f.firstChild);h=f;for(q=[];h!==k&&null!==h;)d(h)&&1===h.nodeType&&q.push(h.cloneNode(!1)),h=h.parentNode;for(v=h=q.pop()||f;0<q.length;)h=q.pop(),v.insertBefore(h,v.firstChild);v!==f?(c.insertBefore(v,c.firstChild),f=h):f=c;k.insertBefore(c,k.firstChild);b=p;g=p.data.length;u=!0;f.insertBefore(b,f.firstChild)}}})(a,k);a.parentNode.insertBefore(k,a);SUNEDITOR.dom.removeItem(a);return{container:b,offset:g}},
    indent:function(a,c){var b=SUNEDITOR.dom.getParentNode(a,"P");if(b){var d=/\d+/.test(b.style.marginLeft)?1*b.style.marginLeft.match(/\d+/)[0]:0;d="indent"===c?d+25:d-25;b.style.marginLeft=(0>d?0:d)+"px"}},toggleFrame:function(){if(this._variable.wysiwygActive)a.element.code.value=a.element.wysiwygWindow.document.body.innerHTML.trim().replace(/<\/p>(?=[^\n])/gi,"</p>\n"),a.element.wysiwygElement.style.display="none",a.element.code.style.display="block",this._variable.wysiwygActive=!1;else{var b={"&amp;":"&",
        ...
        a.element.editorArea.style.height=this._variable.editorHeight+"px",d.removeClass(b.firstElementChild,"ico_full_screen_i"),d.addClass(b.firstElementChild,"ico_full_screen_e")):(a.element.topArea.style.position="fixed",a.element.topArea.style.top="0",a.element.topArea.style.left="0",a.element.topArea.style.width="100%",a.element.topArea.style.height="100%",this._variable.innerHeight_fullScreen=window.innerHeight-a.tool.bar.offsetHeight,a.element.editorArea.style.height=this._variable.innerHeight_fullScreen+
        "px",d.removeClass(b.firstElementChild,"ico_full_screen_e"),d.addClass(b.firstElementChild,"ico_full_screen_i"));this._variable.isFullScreen=!this._variable.isFullScreen},preview:function(){var b=window.open("","_blank");b.mimeType="text/html";b.document.head.innerHTML='<meta charset="utf-8" /><title>'+SUNEDITOR.lang.toolbar.preview+'</title><link rel="stylesheet" type="text/css" href="'+SUNEDITOR.func.getBasePath+'css/suneditor-contents.css">';b.document.body.className="sun-editor-editable";b.document.body.innerHTML=
        a.element.wysiwygWindow.document.body.innerHTML}},f={_shortcutKeyCode:{66:["bold","B"],83:["strikethrough","STRIKE"],85:["underline","U"],73:["italic","I"],89:["redo"],90:["undo"],219:["outdent"],221:["indent"]},_directionKeyKeyCode:/^(?:8|13|32|46|33|34|35|36|37|38|39|40|98|100|102|104)$/,_findButtonEffectTag:function(){for(var b=c._variable.selectionNode,g=!0,f=!0,e=!0,q="B|U|I|STRIKE|FONT|SIZE|",n=new RegExp(q,"i"),m;!/^(?:P|BODY|HTML|DIV)$/i.test(b.nodeName);){if(3!==b.nodeType){var p=[/^STRONG$/.test(b.nodeName)?
        "B":/^EM/.test(b.nodeName)?"I":b.nodeName];g&&1===b.nodeType&&(0<b.style.fontFamily.length||b.face&&0<b.face.length)&&(p.push("FONT"),g=(b.style.fontFamily||b.face||SUNEDITOR.lang.toolbar.font).replace(/["']/g,""),d.changeTxt(c.commandMap.FONT,g),g=!1,q=q.replace("FONT|",""),n=new RegExp(q,"i"));if(e&&/^A$/i.test(b.nodeName)&&null===b.getAttribute("data-image-link")){if(!a.link||c.controllerArray[0]!==a.link.linkBtn){var r=b;c.callModule("dialog","link",null,function(){SUNEDITOR.plugin.link.call_controller_linkButton.call(c,
        r)})}e=!1}else e&&a.link&&c.controllerArray[0]===a.link.linkBtn&&c.controllersOff();f&&0<b.style.fontSize.length&&(d.changeTxt(c.commandMap.SIZE,b.style.fontSize.match(/\d+/)[0]),f=!1,q=q.replace("SIZE|",""),n=new RegExp(q,"i"));m=b.style.cssText;/:\s*bold(?:;|\s)/.test(m)&&p.push("B");/:\s*underline(?:;|\s)/.test(m)&&p.push("U");/:\s*italic(?:;|\s)/.test(m)&&p.push("I");/:\s*line-through(?:;|\s)/.test(m)&&p.push("STRIKE");for(m=0;m<p.length;m++)n.test(p[m])&&(d.addClass(c.commandMap[p[m]],"on"),
        q=q.replace(p[m]+"|",""),n=new RegExp(q,"i"))}b=b.parentNode}e&&c.controllersOff();q=q.split("|");b=q.length-1;for(m=0;m<b;m++)/^FONT/i.test(q[m])?d.changeTxt(c.commandMap[q[m]],SUNEDITOR.lang.toolbar.font):/^SIZE$/i.test(q[m])?d.changeTxt(c.commandMap[q[m]],SUNEDITOR.lang.toolbar.fontSize):d.removeClass(c.commandMap[q[m]],"on")},resize_window:function(){c._variable.isFullScreen&&(c._variable.innerHeight_fullScreen+=window.innerHeight-a.tool.bar.offsetHeight-c._variable.innerHeight_fullScreen,a.element.editorArea.style.height=
        c._variable.innerHeight_fullScreen+"px")},touchstart_toolbar:function(){c._variable.isTouchMove=!1},touchmove_toolbar:function(){c._variable.isTouchMove=!0},onClick_toolbar:function(b){if(c._variable.isTouchMove)return!0;for(var g=b.target,f=g.getAttribute("data-display"),e=g.getAttribute("data-command"),q=g.className;!e&&!/editor_tool/.test(q)&&!/sun-editor-id-toolbar/.test(q);)g=g.parentNode,e=g.getAttribute("data-command"),f=g.getAttribute("data-display"),q=g.className;if(!e&&!f)return!0;b.preventDefault();
        b.stopPropagation();c.focus();if(f)b=c.submenu,c.submenuOff(),!/submenu/.test(f)||null!==g.nextElementSibling&&g.nextElementSibling===b?/dialog/.test(f)&&c.callModule("dialog",e,null,function(){SUNEDITOR.plugin.dialog.openDialog.call(c,e,g.getAttribute("data-option"))}):c.callModule("submenu",e,g,function(){c.submenuOn(g)});else{if(e)switch(f=g.getAttribute("data-value"),e){case "codeView":c.toggleFrame();d.toggleClass(g,"on");break;case "fullScreen":c.toggleFullScreen(g);d.toggleClass(g,"on");break;
            case "indent":case "outdent":c.indent(c._variable.selectionNode,e);break;case "redo":case "undo":case "removeFormat":c.execCommand(e,!1,null);break;case "preview":c.preview();break;case "print":a.element.wysiwygWindow.print();break;default:c.execCommand(e,!1,f),d.toggleClass(g,"on")}c.submenuOff()}},onMouseUp_wysiwyg:function(a){a.stopPropagation();c._setSelectionNode();var b=a.target;c.submenuOff();/^HTML$/i.test(b.nodeName)?(a.preventDefault(),c.focus()):/^IMG$/i.test(b.nodeName)?c.callModule("dialog",
        "image",null,function(){SUNEDITOR.plugin.image._call_controller_imageResize.call(c,b)}):f._findButtonEffectTag()},onKeyDown_wysiwyg:function(b){c._setSelectionNode();var e=b.keyCode,k=b.shiftKey,u=b.ctrlKey||b.metaKey,q=b.altKey;b.stopPropagation();if(u&&!/^(?:16|17|18)$/.test(e)){var n;if(n=!(k&&83!==e))(n=f._shortcutKeyCode[e])?(c.execCommand(n[0],!1,null),d.toggleClass(c.commandMap[n[1]],"on"),n=!0):n=!1;if(n){b.preventDefault();return}}switch(e){case 8:if(/^P$/i.test(c._variable.selectionNode.tagName)&&
        null===c._variable.selectionNode.previousSibling)return b.preventDefault(),!1;break;case 9:if(b.preventDefault(),!u&&!q){for(b=c._variable.selectionNode||c.getSelection().anchorNode;!/^TD$/i.test(b.tagName)&&!/^BODY$/i.test(b.tagName);)b=b.parentNode;if(b&&/^TD$/i.test(b.tagName)){e=d.getParentNode(b,"table");e=d.getListChildren(e,d.isCell);b=k?d.prevIdx(e,b):d.nextIdx(e,b);b!==e.length||k||(b=0);-1===b&&k&&(b=e.length-1);k=e[b];if(!k)return!1;b=c.createRange();b.setStart(k,0);b.setEnd(k,0);k=c.getSelection();
        0<k.rangeCount&&k.removeAllRanges();k.addRange(b)}else k||(b=a.element.wysiwygWindow.document.createTextNode(Array(c._variable.tabSize+1).join("\u00a0")),c.insertNode(b,null),k=c.getSelection(),e=c.createRange(),e.setStart(b,c._variable.tabSize),e.setEnd(b,c._variable.tabSize),0<k.rangeCount&&k.removeAllRanges(),k.addRange(e))}}},onKeyUp_wysiwyg:function(a){c._setSelectionNode();f._directionKeyKeyCode.test(a.keyCode)&&f._findButtonEffectTag()},onScroll_wysiwyg:function(){c.controllersOff()},onMouseDown_resizeBar:function(b){function d(){a.element.resizeBackground.style.display=
    ...
    e)throw Error('[SUNEDITOR.create.fail] The element for that id was not found (ID:"'+a+'")');var c=B(e,d);if(document.getElementById(c.constructed._top.id))throw Error('[SUNEDITOR.create.fail] The ID of the suneditor you are trying to create already exists (ID:"'+c.constructed._top.id+'")');"object"===typeof e.nextElementSibling?e.parentNode.insertBefore(c.constructed._top,e.nextElementSibling):e.parentNode.appendChild(c.constructed._top);e.style.display="none";var f=c.constructed;c=c.options;e={element:{textElement:e,
        ...
        height:c.height.match(/\d+/)[0]}};return F(e,D,C)};SUNEDITOR.destroy=function(a){var d=document.getElementById("suneditor_"+a);d.parentNode.removeChild(d);document.getElementById(a).style.display=""}})();