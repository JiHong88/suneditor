...
export interface Core {
	...
	/**
	 * @description Computed style of the wysiwyg area window.getComputedStyle(this.frameContext('wysiwyg'))
	 */
	wwComputedStyle: any;
	 ...
	 * @param html WYSIWYG element (this.frameContext.get('wysiwyg')) or HTML string.
