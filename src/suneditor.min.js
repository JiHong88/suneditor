...
this.contentWindow.document.body.setAttribute("contenteditable",!0);this.contentWindow.document.body.innerHTML=A(a.value)});var u=e.createElement("DIV");u.className="sun-editor-id-resizeBar";var n=e.createElement("SPAN");n.className="sun-editor-id-navigation";var l=e.createElement("SPAN");l.innerHTML="&nbsp;";var k=e.createElement("DIV");k.className="sun-editor-id-loading";k.innerHTML='<div class="loading-effect"></div>';e=e.createElement("DIV");e.className="sun-editor-id-resize-background";f.appendChild(p);
f.appendChild(w);u.appendChild(l);u.appendChild(n);g.appendChild(d);g.appendChild(f);g.appendChild(u);g.appendChild(e);g.appendChild(k);c.appendChild(g);return{constructed:{_top:c,_relative:g,_toolBar:d,_editorArea:f,_resizeBar:u,_navigation:n,_loading:k,_resizeBack:e},options:b}}SUNEDITOR.util={getXMLHttpRequest:function(){if(window.ActiveXObject)try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(a){try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(b){return null}}else return window.XMLHttpRequest?
new XMLHttpRequest:null},copyObj:function(a){var b={},e;for(e in a)b[e]=a[e];return b},getBasePath:function(){var a=SUNEDITOR.SUNEDITOR_BASEPATH||"";if(!a)for(var b=document.getElementsByTagName("script"),e=0;e<b.length;e++){var c=b[e].src.match(/(^|.*[\\\/])suneditor(\.min)?\.js(?:\?.*|;.*)?$/i);if(c){a=c[1];break}}-1===a.indexOf(":/")&&"//"!==a.slice(0,2)&&(a=0===a.indexOf("/")?location.href.match(/^.*?:\/\/[^\/]*/)[0]+a:location.href.match(/^[^\?]*\/(?:)/)[0]+a);if(!a)throw'[SUNEDITOR.util.getBasePath.fail] The SUNEDITOR installation path could not be automatically detected. Please set the global variable "SUNEDITOR.SUNEDITOR_BASEPATH" before creating editor instances.';
...
"none"},appendP:function(a){var d=document.createElement("P");d.innerHTML="&#65279";a=b.getFormatElement(a);a.parentNode.insertBefore(d,a.nextElementSibling);return d},insertNode:function(a,b){if(b){var d=b.parentNode;b=b.nextSibling}else{var c=this.getSelection();d=this.getRange();var f=d.startContainer,e=d.startOffset,g=d.endContainer,k=d.endOffset;d=f;3===f.nodeType&&(d=f.parentNode);if(f===g&&e===k)c.focusNode&&3===c.focusNode.nodeType?b=c.focusNode.splitText(k):(null!==d.lastChild&&/^BR$/i.test(d.lastChild.nodeName)&&
d.removeChild(d.lastChild),b=null);else if(f===g)c=f,this.isEdgePoint(g,k)||(b=g.splitText(k)),this.isEdgePoint(f,e)||(c=f.splitText(e)),d.removeChild(c);else for(c.deleteFromDocument?c.deleteFromDocument():this.removeNode(),b=g;1!==b.nodeType;)b=b.parentNode}try{d.insertBefore(a,b)}catch(r){d.appendChild(a)}},removeNode:function(){var a=this.getRange(),c=a.startContainer,p=a.startOffset,e=a.endContainer,g=a.endOffset;a=b.getListChildNodes(a.commonAncestorContainer);var n=b.getArrayIndex(a,c),l=b.getArrayIndex(a,
e);var k=n+1;for(var r=c;0<=k;k--)a[k]===r.parentNode&&a[k].firstChild===r&&0===p&&(n=k,r=r.parentNode);k=l-1;for(r=e;k>n;k--)a[k]===r.parentNode&&1===a[k].nodeType&&(a.splice(k,1),r=r.parentNode,--l);for(;n<=l;n++)k=a[n],0===k.length||3===k.nodeType&&void 0===k.data?b.removeItem(k):k===c?(k=1===c.nodeType?document.createTextNode(c.textContent):document.createTextNode(c.substringData(0,p)),0<k.length?c.data=k.data:b.removeItem(c)):k===e?(k=1===e.nodeType?document.createTextNode(e.textContent):document.createTextNode(e.substringData(g,
e.length-g)),0<k.length?e.data=k.data:b.removeItem(e)):b.removeItem(k)},wrapRangeToTag:function(a,c){var d=this.getRange(),f=d.startContainer,e=d.startOffset,g=d.endContainer,l=d.endOffset,k=d.commonAncestorContainer;d={};var r={},m;if(c){var h="(?:;|^|\\s)(?:"+c[0];for(m=1;m<c.length;m++)h+="|"+c[m];h+=")\\s*:[^;]*\\s*(?:;|$)";h=new RegExp(h,"gi")}if(f===g){m=a.cloneNode(!1);if(e===l)m.innerHTML="&nbsp;",this._isformatTagName.test(f.nodeName)?f.appendChild(m):f.parentNode.insertBefore(m,f.nextSibling);
else if(1===f.nodeType)m.innerHTML=f.outerHTML,f.parentNode.appendChild(m),b.removeItem(f);else{g=document.createTextNode(f.substringData(0,e));var v=document.createTextNode(f.substringData(l,f.length-l));m.innerText=f.substringData(e,l-e);f.parentNode.insertBefore(m,f.nextSibling);f.data=0<g.data.length?g.data:f.substringData(0,e);0<v.data.length&&f.parentNode.insertBefore(v,m.nextSibling)}d.container=m;d.offset=0;r.container=m;r.offset=1}else if(v=function(d){if(3===d.nodeType)return!0;var b="";
h&&0<d.style.cssText.length&&(b=d.style.cssText.replace(h,"").trim());return d.nodeName!==a.nodeName||0<b.length?(0<d.style.cssText.length&&(d.style.cssText=b),!0):!1},/BODY/i.test(k.nodeName)){r=b.getListChildren(k,function(a){return this._isformatTagName.test(a.nodeName)});var z=b.getParentElement(f,"P");k=b.getParentElement(g,"P");d=0;for(m=r.length;d<m;d++)if(z===r[d])z=d;else if(k===r[d]){k=d;break}m=a.cloneNode(!1);d=this._wrapLineNodesStart(r[z],m,v,f,e);for(f=z+1;f<k;f++)m=a.cloneNode(!1),
this._wrapLineNodes(r[f],m,v);m=a.cloneNode(!1);r=this._wrapLineNodesEnd(r[k],m,v,g,l)}else m=a.cloneNode(!1),l=this._wrapLineNodesPart(k,m,v,f,e,g,l),d.container=l.startContainer,d.offset=l.startOffset,r.container=l.endContainer,r.offset=l.endOffset;this.setRange(d.container,d.offset,r.container,r.offset)},_wrapLineNodesPart:function(a,c,e,g,u,n,l){var d=[],f=g,p=u,h=n,v=l,w=!1,x=!1,t,q,y;(function D(g,k){for(var m=g.childNodes,l=0,r=m.length;l<r&&!x;l++){var n=m[l];if(w&&n!==h&&3===n.nodeType){for(t=
[];q!==a&&null!==q;)e(q)&&1===q.nodeType&&t.push(q.cloneNode(!1)),q=q.parentNode;if(0<t.length){for(y=q=t.pop();0<t.length;)q=t.pop(),y.appendChild(q);c.appendChild(y);k=q}else k=c;k.appendChild(n.cloneNode(!1));d.push(n)}if(n===f){var u=document.createTextNode(f.substringData(0,p)),E=document.createTextNode(f.substringData(p,f.length-p));0<u.length?f.data=u.data:d.push(f);q=n;for(t=[];q!==a&&null!==q;)e(q)&&1===q.nodeType&&t.push(q.cloneNode(!1)),q=q.parentNode;for(y=q=t.pop()||n;0<t.length;)q=t.pop(),
y.appendChild(q);y!==n?(c.appendChild(y),k=q):k=c;f=E;p=0;k.appendChild(f);w=!0}else{if(n===h){m=document.createTextNode(h.substringData(v,h.length-v));l=document.createTextNode(h.substringData(0,v));r=q=n;for(t=[];q!==a&&null!==q;)e(q)&&1===q.nodeType&&t.push(q.cloneNode(!1)),r=q,q=q.parentNode;for(y=q=t.pop()||n;0<t.length;)q=t.pop(),y.appendChild(q);y!==n?(c.appendChild(y),k=q):k=c;0<m.length?h.data=m.data:d.push(h);h=l;v=l.length;k.appendChild(h);for(a.insertBefore(c,r);0<d.length;){n=d.pop();
for(n.data="";n.parentNode&&0===n.parentNode.innerText.length;)n=n.parentNode;b.removeItem(n)}x=!0;break}D(n)}}})(a);return{startContainer:f,startOffset:p,endContainer:h,endOffset:v}},_wrapLineNodes:function(a,b,c){(function l(a,d){for(var b=a.childNodes,f=0,e=b.length;f<e;f++){var g=b[f],p=d;if(c(g)){var n=g.cloneNode(!1);d.appendChild(n);1===g.nodeType&&(p=n)}l(g,p)}})(a,b);a.innerHTML="";a.appendChild(b)},_wrapLineNodesStart:function(a,c,e,g,u){var d=document.createElement("P"),f=g,p=u,r=!1,m,
h,w;(function q(b,g){for(var k=b.childNodes,n=0,t=k.length;n<t;n++){var l=k[n],u=g;if(r){if(1===l.nodeType){q(l,l);continue}h=l;for(m=[];null!==h.parentNode&&h!==a&&h!==c;)e(h)&&1===h.nodeType&&m.push(h.cloneNode(!1)),h=h.parentNode;if(0<m.length){for(w=h=m.pop();0<m.length;)h=m.pop(),w.appendChild(h);c.appendChild(w);g=h}else g=c}if(r||l!==f){if(!r||e(l)){var v=l.cloneNode(!1);g.appendChild(v);1===l.nodeType&&(u=v)}q(l,u)}else{l=document.createTextNode(f.substringData(0,p));u=document.createTextNode(f.substringData(p,
f.length-p));0<l.data.length&&g.appendChild(l);h=g;for(m=[];h!==d&&null!==h;)e(h)&&1===h.nodeType&&m.push(h.cloneNode(!1)),h=h.parentNode;for(w=h=m.pop()||g;0<m.length;)h=m.pop(),w.appendChild(h);w!==g?(c.appendChild(w),g=h):g=c;d.appendChild(c);f=u;p=0;r=!0;g.appendChild(f)}}})(a,d);a.parentNode.insertBefore(d,a);b.removeItem(a);return{container:f,offset:p}},_wrapLineNodesEnd:function(a,c,g,e,u){var d=document.createElement("P"),f=e,p=u,w=!1,m,h,v;(function q(b,e){for(var k=b.childNodes,n=k.length-
1;0<=n;n--){var l=k[n],r=e;if(w){if(1===l.nodeType){q(l,l);continue}h=l;for(m=[];null!==h.parentNode&&h!==a&&h!==c;)g(h)&&1===h.nodeType&&m.push(h.cloneNode(!1)),h=h.parentNode;if(0<m.length){for(v=h=m.pop();0<m.length;)h=m.pop(),v.insertBefore(h,v.firstChild);c.insertBefore(v,c.firstChild);e=h}else e=c}if(w||l!==f){if(!w||g(l)){var t=l.cloneNode(!1);e.insertBefore(t,e.firstChild);1===l.nodeType&&(r=t)}q(l,r)}else{l=document.createTextNode(f.substringData(p,f.length-p));r=document.createTextNode(f.substringData(0,
p));0<l.data.length&&e.insertBefore(l,e.firstChild);h=e;for(m=[];h!==d&&null!==h;)g(h)&&1===h.nodeType&&m.push(h.cloneNode(!1)),h=h.parentNode;for(v=h=m.pop()||e;0<m.length;)h=m.pop(),v.insertBefore(h,v.firstChild);v!==e?(c.insertBefore(v,c.firstChild),e=h):e=c;d.insertBefore(c,d.firstChild);f=r;p=r.data.length;w=!0;e.insertBefore(f,e.firstChild)}}})(a,d);a.parentNode.insertBefore(d,a);b.removeItem(a);return{container:f,offset:p}},indent:function(a,c){var d=b.getParentElement(a,"P");if(d){var f=/\d+/.test(d.style.marginLeft)?
