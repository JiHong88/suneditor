...
export default {
    ...
    active: function (element) {
        if (!element) {
            this.util.changeTxt(this.context.fontSize.targetText, this.status.hasFocus ? (this.options.__defaultFontSize || this.wwComputedStyle.fontSize) : this.lang.toolbar.fontSize);
    ...
    pickup: function (e) {
        ...
        if (value) {
            ...
            this.format.applyStyleNode(newNode, ['font-size'], null, null);
        } else {
