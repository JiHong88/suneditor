...
FontSize.prototype = {
	...
	active: function (element) {
		if (!element) {
			domUtils.changeTxt(this.targetText, this.status.hasFocus ? this.editor.frameContext.get('wwComputedStyle').fontSize || this.options.get('__defaultFontSize') : this.lang.fontSize);
