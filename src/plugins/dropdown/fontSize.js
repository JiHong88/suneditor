...
FontSize.prototype = {
	...
	active: function (element) {
		if (!element) {
			domUtils.changeTxt(this.targetText, this.status.hasFocus ? this.options.get('__defaultFontSize') || this.editor.frameContext.get('wwComputedStyle').fontSize : this.lang.fontSize);
